 ...
 *
 * <p><b>对系统时间的依赖性非常强，需要关闭ntp的时间同步功能，或者当检测到ntp时间调整后，拒绝分配id。
 *
 * @see <a href=https://github.com/sumory/uc/blob/master/src/com/sumory/uc/id/IdWorker.java></a>
 */
public class IdWorker {
  ...
  public synchronized long nextId() throws Exception {
    ...
    if (this.lastTimestamp
        == timestamp) { // 如果上一个timestamp与新产生的相等，则sequence加一(0-4095循环)，下次再使用时sequence是新值
  ...
  public static void main(String[] args) throws Exception {
    ...
    long result =
        ct - twepoch << timestampLeftShift
            | workerId << workerIdShift
            | sequence; // 取时间的低40位 | （小于1024:只有12位）的低12位 | 计算的sequence
